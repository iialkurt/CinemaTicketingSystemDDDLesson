...
namespace CinemaTicketingSystem.Infrastructure.Configurations.CinemaManagement;
...
public class CinemaConfiguration : IEntityTypeConfiguration<Cinema>
{
    public void Configure(EntityTypeBuilder<Cinema> builder)
    {
        ...
        builder.HasIndex(c => c.Name)
            .HasDatabaseName("IX_Cinemas_Name");

        builder.HasIndex(c => c.CreationTime)
            .HasDatabaseName("IX_Cinemas_CreationTime");

        builder.HasIndex(c => c.IsDeleted)
            .HasDatabaseName("IX_Cinemas_IsDeleted");
