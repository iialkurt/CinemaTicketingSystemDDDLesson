...
namespace CinemaTicketingSystem.Application
{
    public class AppDependencyService(IUnitOfWork unitOfWork, ILocalizer localizer)
    {
        ...
        public AppResult<T> Error<T>(string ErrorCodeAsTitle, object[]? ErrorCodeAsTitlePlaceHolder, HttpStatusCode statusCode)
        {
        ...
        public AppResult<T> Error<T>(string ErrorCodeAsTitle, object[]? errorCodeAsTitlePlaceHolder, string errorCodeAsDescription, object[]? errorCodeAsDescriptionPlaceHolder, HttpStatusCode statusCode = HttpStatusCode.BadRequest)
        {
